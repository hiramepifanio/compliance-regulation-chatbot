...
## User Flows
1. **Startup**: System pre-indexes documents in the `/data` folder using Semantic Chunking.
...
- **Data Integrity**: Ingestion must handle HTML tables without fragmenting row-level relationships.

## Acceptance Criteria
- [ ] Successfully parses HTML tables (RoHS/REACH limit tables).
